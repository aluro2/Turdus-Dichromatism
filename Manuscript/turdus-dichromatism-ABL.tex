...
\caption {Hypotheses and predictions by model. Arrow colors indicate predicted correlation, positive(\textcolor{blue}{\textbf{blue}}) and negative (\textcolor{red}{\textbf{red}}).\label{fig:01-hypotheses}}
\end{figure}
