...
closely-related species are highly sympatric, when the time to find a
mate is limited, and when conspecifics are not encountered often
...
hybridization avoidance via character displacement to facilitate species
and mate recognition. For example, in European \emph{Ficedula}
flycatchers, female choice selects for divergent male plumage
colouration, leading to character displacement between species and
populations and reduced rates of hybridization
{[}\protect\hyperlink{ref-saetre1997}{24}{]}. More broadly and across
taxa, greater plumage dichromatism is positively correlated with
transitions from allopatry to parapatry and increases in geographic
range overlaps among passerine sister species pairs
...
{[}\protect\hyperlink{ref-clement2000}{28},\protect\hyperlink{ref-nagy2019}{29}{]}.
...
{[}\protect\hyperlink{ref-mccarthy2006}{30}{]}, indicating that some
...
patches {[}\protect\hyperlink{ref-andersson2006}{31}{]} of each
...
{[}\protect\hyperlink{ref-vorobyev1998}{32}{]} of the European Blackbird
(\emph{T. merula}) visual system
{[}\protect\hyperlink{ref-hart2000}{33}{]} in the \emph{pavo}
{[}\protect\hyperlink{ref-maia2019}{34}{]}⁠ package in R v4.0.0
{[}\protect\hyperlink{ref-rcoreteam2020}{35}{]}⁠ to calculate
...
temporally {[}\protect\hyperlink{ref-endler1993}{36}{]}⁠, bringing into
...
contrast {[}\protect\hyperlink{ref-kemp2015}{37}{]}⁠. Additionally, we
...
\emph{Thrushes} {[}\protect\hyperlink{ref-clement2000}{28}{]} and the
\emph{Handbook of the Birds of the World}
{[}\protect\hyperlink{ref-delhoyo2017}{38}{]}⁠. We assigned three
...
International}
{[}\protect\hyperlink{ref-birdlifeinternationalandhandbookofthebirdsoftheworld2018}{39}{]}⁠.
We calculated congener breeding range overlaps (as percentages) using
the \emph{letsR} package in R
{[}\protect\hyperlink{ref-vilela2015}{40}{]}⁠. We then calculated the
...
range {[}\protect\hyperlink{ref-cooney2017}{25}{]}. Comparisons of the
...
{[}\protect\hyperlink{ref-burkner2017}{41}{]} in R v4.0.0
{[}\protect\hyperlink{ref-rcoreteam2020}{35}{]}⁠ where responses, the
...
{[}\protect\hyperlink{ref-nylander2008}{42}{]} to create a covariance
...
{[}\protect\hyperlink{ref-gelman2013}{43}{]}. We then performed k-fold
cross-validation {[}\protect\hyperlink{ref-vehtari2017}{44}{]} to refit
...
{[}\protect\hyperlink{ref-vehtari2017}{44}{]}⁠.
...
{[}\protect\hyperlink{ref-makowski2019}{45}{]}, to provide estimates of
...
{[}\protect\hyperlink{ref-makowski2019}{45}{]}.
...
(2002){[}\protect\hyperlink{ref-burnham2002}{46}{]}). Among models
...
In support of the species recognition hypothesis for plumage sexual
dimorphism, we found that the odds of plumage sexual dimorphism are
greater for species that migrate, have short breeding seasons, and are
in sympatry with many other congeneric species (Table 1,2).
