...
only} models in predicting the number of sexually dimorphic plumage
patches with achromatic JND values \textgreater{} 1, 2, or 3 (Table 1;
all models predicting achromatic plumage patches had ELPD values within
4, following the convention of Burnham and Anderson
(2002){[}\protect\hyperlink{ref-burnham2002}{17}{]}). Among models
predicting the number of sexually-dichromatic plumage patches with
chromatic JND values \textgreater1, 2, or 3, all models performed much
better than \emph{intercept only} models, and \emph{breeding sympatry}
models had the best predictive performance (Table 1; \emph{breeding
sympatry} models all have ELPD =0, only the \emph{breeding spacing}
models predicting dichromatic plumage patches with had similar
