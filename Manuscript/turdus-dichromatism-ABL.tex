...
\emph{Table 2: Model predictor effect estimates (posterior median
log-odds) on the number of achromatic and chromatic plumage patches with
visual contrast values \textgreater{} 1, 2, and 3 JND. Model effects
with a probability of direction (pd) value ≥}

\emph{0.90 are bolded in red for a negative effect and blue for a
positive effect on plumage dichromatism.}
