...
species on plumage dimorphism. As predicted, we found that 1) true
thrush species with migratory behaviour have greater plumage sexual
dimorphism than non-migratory species, 2) species with longer breeding
seasons have less sexual dichromatism, and 3) the number of
\emph{Turdus} thrush species breeding in sympatry is associated with
more plumage dimorphism. These results suggest that social recognition
systems, including species and mate recognition, play a prominent role
in the evolution of thrush plumage sexual dimorphism.
...
greater species divergence and richness
...
\textasciitilde86 species distributed across the globe (Fig. 1). The
true thrushes are an ideal passerine clade for examining the species
recognition hypothesis for plumage sexual dimorphism. Plumage sexual
dimorphism and migratory behaviours vary substantially between species
...
models, we used the \emph{Turdus} molecular phylogeny from Nylander et
al.~(2008) {[}\protect\hyperlink{ref-nylander2008}{45}{]} to create a
covariance matrix of species' phylogenetic relationships. All models
used a dataset of N=67 out of the \emph{Turdus} species for which all
the types of data (see above) were available.
...
predictions of the recognition hypothesis for plumage sexual dimorphism
in true thrushes. We used a receptor-noise limited model of \emph{Turdus
merula} vision
...
occurred and all four species exhibit strong plumage sexual dimorphism
...
plumage sexual dimorphism. Migratory behaviour and limited breeding
...
sexual dimorphism likely reduces species and mate recognition errors and
decreases hybridization.
